...
<body>
    ...
    <main class="main" id="top">
            ...
            <div class="container"><a class="navbar-brand d-flex align-items-center fw-bolder fs-2 fst-italic" href="#">
                ...
                <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
                        ...
                        <li class="nav-item px-2"><a class="nav-link fw-medium" href="#features">Tentang Kami</a></li>
                        <li class="nav-item px-2"><a class="nav-link fw-medium" href="#pricing">Jadwal</a></li>
                    </ul>
                    <form class="ps-lg-5">
        ...
        <section class="py-0" id="home">
            ...
            <div class="bg-holder d-sm-none" style="background-image:url(assets/public/assets/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
            </div>
            <!--/.bg-holder-->
        ...
        <section class="py-0">
            ...
            <div class="container">
                ...
                <section class="py-8">
                    ...
                    <div class="container">
                        <div class="row flex-center">
                            <div class="col-md-5 order-md-1 text-center text-md-end"><img class="img-fluid mb-4" src="<?= base_url(); ?>'/assets/public/assets/img/illustrations/jobs.png'" width=" 450" alt="" /></div>
                            <div class="col-md-5 text-center text-md-start">
