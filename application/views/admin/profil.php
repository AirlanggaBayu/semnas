            ...
            <form action="<?= base_url('admin/jadwal/simpan') ?>" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="jadwal" aria-describedby="emailHelp" placeholder="Masukkan Profil">
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/jadwal/update') ?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Profil</label>
                        <input type="text" class="form-control" name="jadwal" id="jadwal" aria-describedby="emailHelp" placeholder="Masukkan Profil">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Tanggal</label>
